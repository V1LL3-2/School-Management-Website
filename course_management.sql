...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2025 at 12:50 PM
...
(1, 'admin', 'admin@school.com', '$2y$10$07J/Ck1ISIkhF5WM3SQP2uuxzG5zoQ.3/uDJV1OZTh7HKEMtxs2Xi', 'admin', NULL, NULL, 'System', 'Administrator', '2025-09-03 05:16:32', '2025-09-03 10:47:29', 1),
...
(14, 'Koulutuspaalikko', 'koulutuspaalikko@edu.turku.fi', '$2y$10$rCZvX56jo0MI4gWIPGr2b.TwgxUE6jWJgW94uDAFCfQJFusWrdpQW', 'admin', NULL, NULL, 'Koulutus', 'paalikko', '2025-09-03 05:42:30', '2025-09-03 09:52:19', 1),
...
--
ALTER TABLE `course_logins`
  MODIFY `emblem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `teachers`
  MODIFY `identification_number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`identification_number`) ON DELETE SET NULL,
  ADD CONSTRAINT `courses_ibfk_2` FOREIGN KEY (`facility_id`) REFERENCES `facilities` (`emblem`) ON DELETE SET NULL;

--
-- Constraints for table `course_logins`
--
ALTER TABLE `course_logins`
  ADD CONSTRAINT `course_logins_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_number`) ON DELETE CASCADE,
  ADD CONSTRAINT `course_logins_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `courses` (`emblem`) ON DELETE CASCADE;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_number`) ON DELETE SET NULL,
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`identification_number`) ON DELETE SET NULL;
COMMIT;
